...
> `Cuantización (e)` · `Conservación local` · `Dos signos` · `Invariancia relativista` · `Coulomb 1/r²` · `Culombio` · `Quarks fraccionarios`
...
La razón profunda es matemática: la carga eléctrica es un número real (en la práctica, un entero por $e$) y los números tienen **exactamente dos signos**. La fuerza entre dos cargas es proporcional al **producto** $q_1 q_2$:
...
## 8. Puente a redes y telecomunicaciones
...
> [!tip] Recorré el palacio en orden: entrada → cajero → bóveda → balanza → sala de espejos.
...
|---|-------|-----------------|--------|
| 1 (Día 1) | 2026-08-13 | ✅ / ⚠️ / ❌ | |
| 2 (Día 3) | 2026-08-15 | ✅ / ⚠️ / ❌ | |
| 3 (Día 7) | 2026-08-19 | ✅ / ⚠️ / ❌ | |
| 4 (Día 14) | 2026-08-26 | ✅ / ⚠️ / ❌ | |
| 5 (Día 30) | 2026-09-11 | ✅ / ⚠️ / ❌ | |
| 6 (Día 60) | 2026-10-11 | ✅ / ⚠️ / ❌ | |
