...
- **2026-06-26 · Tags malformados generalizados:** varias notas (`resistencia`, `voltaje`, `ondas-gravitacionales`…) tienen tags con `#` dentro del YAML entre comillas (`"#tema/física"`), lo que viola la convención de CLAUDE.md (en frontmatter SIN `#`). Es sistémico — candidato a un pase de `organizador-boveda` cuando el usuario lo apruebe. No corregido aún (fuera del alcance pedido).
